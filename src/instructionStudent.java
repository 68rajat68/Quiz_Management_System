...
public String rollNo;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(107, 30, -1, -1));
        ...
        jTextArea1.setText("    \t\t\t--- Instruction for students ---\n\n1. Student has only 10 min. in this paper.\n\n2. Student can select anyone option from given questions.\n\n3. Student can submit before time also.\n\n4. Student will get 2 mark for each correct answer .\n\n5. All the Best.");
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 118, 1354, 500));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 659, -1, -1));
